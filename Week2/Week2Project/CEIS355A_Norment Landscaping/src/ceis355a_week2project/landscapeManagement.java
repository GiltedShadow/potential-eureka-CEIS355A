 ...
 * @author never
 */
public class landscapeManagement extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public landscapeManagement() {
        initComponents();
    }
...
"Length must be must be greater than 0",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(landscapeManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new landscapeManagement().setVisible(true);
            }
        });
    }
